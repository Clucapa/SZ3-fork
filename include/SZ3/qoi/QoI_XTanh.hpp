#ifndef SZ3_QOI_XTANH_HPP
#define SZ3_QOI_XTANH_HPP
...
class QoI_XTanh : public concepts::QoIIf<T, N> {
public:
    QoI_XTanh(double tol, T geb)
        : tol_(tol), geb_(geb) {
        concepts::QoIIf<T, N>::id = 10;  // nibble 0xA
    }
