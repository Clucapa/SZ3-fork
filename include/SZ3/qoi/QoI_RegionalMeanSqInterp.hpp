#ifndef SZ3_QOI_REGIONAL_MEAN_SQ_INTERP_HPP
...
template <typename T, uint N>
class RegionalMeanSqInterpEBProvider : public concepts::EBProvider<T> {
public:
    RegionalMeanSqInterpEBProvider(QoI_RegionalMeanSqInterp<T, N> *qoi)
        : qoi_(qoi), pos_(0) {}
...
private:
    QoI_RegionalMeanSqInterp<T, N> *qoi_;
    size_t pos_;
};
